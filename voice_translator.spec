...
a = Analysis(
    ...
    datas=[
        # 模型随包（models -> 内嵌资源）
        ('models/moonshine-zh', 'models/moonshine-zh'),
        ('models/opus-mt-zh-en-ct2-int8', 'models/opus-mt-zh-en-ct2-int8'),
        ('models/opus-mt-tokenizer', 'models/opus-mt-tokenizer'),
        ('models/tinytts-onnx', 'models/tinytts-onnx'),
